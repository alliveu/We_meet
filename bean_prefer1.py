...
Original file is located at
    https://colab.research.google.com/drive/1haJHXXI86Z5p50Cq9IK3CSfJd-q0BFwo
"""
...
Original file is located at
    https://colab.research.google.com/drive/1Zf4hfu7o-wNp-Ll5tEV1stsAveH_hKKz
"""
...
if purchase_history == "예":
    ...
    if st.button("추천 원두 확인"):
        ...
        if st.session_state.recommended_beans:
            for i, bean in enumerate(st.session_state.recommended_beans, start=1):
                st.write(f"{i}. {bean}")
            evaluate_recommendations(recommend_beans(predicted_cafe)[i])